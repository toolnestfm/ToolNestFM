...
export const tools: Tool[] = [
  // ─── 🏛 Government Tools (8) ───────────────────────────────────────────
  { id: 1, slug: 'passport-photo-maker', name: 'Passport Photo Maker', description: 'Create compliant passport photos with country presets', category: 'government', icon: 'user-square', runner: 'gov-photo-advanced', mode: 'gov-spec', accept: IMG, config: { specIds: ['passport-india', 'passport-us', 'passport-uk', 'passport-schengen'] }, keywords: ['passport', 'photo', 'visa', 'id'] },
  { id: 2, slug: 'passport-signature-resizer', name: 'Passport Signature Resizer', description: 'Resize signature to passport upload specifications', category: 'government', icon: 'pen', runner: 'gov-photo-advanced', mode: 'gov-spec', accept: IMG, config: { specIds: ['passport-signature-small', 'passport-signature-large'] } },
  ...
  { id: 4, slug: 'aadhaar-photo-resizer', name: 'Aadhaar Photo Resizer', description: 'Resize photo to UIDAI Aadhaar specifications', category: 'government', icon: 'user-square', runner: 'gov-photo-advanced', mode: 'gov-spec', accept: IMG, config: { specIds: ['aadhaar-photo'] } },
  { id: 5, slug: 'aadhaar-pdf-compressor', name: 'Aadhaar PDF Compressor', description: 'Compress Aadhaar PDF to UIDAI upload size limits', category: 'government', icon: 'file-down', runner: 'pdf-compressor', mode: 'compress', accept: PDF, config: { targetKB: 200 } },
  { id: 6, slug: 'voter-id-photo-resizer', name: 'Voter ID Photo Resizer', description: 'Resize photo to Voter ID (EPIC) specifications', category: 'government', icon: 'user-square', runner: 'gov-photo-advanced', mode: 'gov-spec', accept: IMG, config: { specIds: ['voter-photo'] } },
  { id: 7, slug: 'driving-licence-photo-resizer', name: 'Driving Licence Photo Resizer', description: 'Resize photo & signature for DL (Sarathi) uploads', category: 'government', icon: 'user-square', runner: 'gov-photo-advanced', mode: 'gov-spec', accept: IMG, config: { specIds: ['dl-photo', 'dl-signature'] } },
  { id: 8, slug: 'exam-photo-signature-resizer', name: 'Exam Photo & Signature Resizer', description: 'SSC, UPSC, IBPS, NEET compliant photo & signature', category: 'government', icon: 'user-square', runner: 'gov-photo-advanced', mode: 'gov-spec', accept: IMG, config: { specIds: ['ssc-photo', 'ssc-signature', 'upsc-photo', 'ibps-photo', 'ibps-signature', 'neet-photo'] } },
  ...
  { id: 13, slug: 'compress-pdf', name: 'PDF Compressor', description: 'AI-powered PDF compression — smart modes, batch queue, quality reports & 100% private', category: 'pdf', icon: 'file-down', badge: 'popular', runner: 'pdf-compressor', mode: 'compress', accept: PDF, multiple: true, keywords: ['compress pdf', 'reduce pdf size', 'pdf optimizer', 'shrink pdf', 'pdf compression free'] },
  ...
  { id: 134, slug: 'n-up-pdf', name: 'N-up PDF', description: 'Print-saver: combine 2, 4 or 8 pages onto one sheet', category: 'pdf', icon: 'grid', badge: 'new', runner: 'pdf', mode: 'nup', accept: PDF, keywords: ['n-up', '2up', '4up', 'pages per sheet', 'print', 'booklet'] },
  { id: 135, slug: 'pdf-metadata-editor', name: 'PDF Metadata Editor', description: 'View and edit title, author, subject and keywords of a PDF', category: 'pdf', icon: 'braces', badge: 'new', runner: 'pdf', mode: 'metadata', accept: PDF, keywords: ['metadata', 'title', 'author', 'exif', 'properties'] },
  { id: 136, slug: 'remove-pdf-pages', name: 'Remove PDF Pages', description: 'Delete selected pages from a PDF (e.g. 2, 5-7)', category: 'pdf', icon: 'scissors', badge: 'new', runner: 'pdf', mode: 'pagedel', accept: PDF, keywords: ['remove pages', 'delete pages'] },
  { id: 137, slug: 'extract-pdf-pages', name: 'Extract PDF Pages', description: 'Pull selected pages out into a new PDF (e.g. 1, 3-4)', category: 'pdf', icon: 'split', badge: 'new', runner: 'pdf', mode: 'pageext', accept: PDF, keywords: ['extract pages', 'pull pages', 'select pages'] },
  ...
  // ─── 🤖 AI Tools (12) ──────────────────────────────────────────────────
  { id: 49, slug: 'ai-chat', name: 'AI Chat Assistant', description: 'Advanced AI chat with 6 personas, chat history, PDF Q&A, streaming, markdown & full controls', category: 'ai', icon: 'bot', badge: 'ai', runner: 'ai-chat', mode: 'chat', keywords: ['ai chat', 'chatgpt alternative', 'gemini chat', 'ai assistant free', 'pdf chat'] },
